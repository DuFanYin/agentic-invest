...
@pytest.mark.parametrize("method,args", [("search", ("Apple",)), ("search_news", ("AAPL",))])
...
@pytest.mark.parametrize("exc", [_httpx.TimeoutException("timed out"), _httpx.NetworkError("unreachable")])
